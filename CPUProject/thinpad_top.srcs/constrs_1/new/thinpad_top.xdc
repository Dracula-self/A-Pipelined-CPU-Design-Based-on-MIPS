...
create_clock -period 20.000 -name clk_50M -waveform {0.000 10.000} [get_ports clk_50M] -add
...
set ram_input_delay [expr 5]  
set ram_output_delay [expr 2] 
...
set_output_delay -clock $cpu_clk $ram_output_delay [get_ports base_ram_ce_n]
...
## 多周期路径约束
#   set_multicycle_path -setup 2 -from [get_ports {base_ram_data[*]}]
#   set_multicycle_path -hold 1 -from [get_ports {base_ram_data[*]}]
#   set_multicycle_path -setup 2 -from [get_ports {ext_ram_data[*]}]
#   set_multicycle_path -hold 1 -from [get_ports {ext_ram_data[*]}]
## RAM接口时序控制 - 添加到RAM约束下方
#set_max_delay 6 -from [get_clocks gyfclock] -to [get_ports {base_ram_ce_n base_ram_oe_n base_ram_we_n}]
#set_max_delay 6 -from [get_clocks gyfclock] -to [get_ports {ext_ram_ce_n ext_ram_oe_n ext_ram_we_n}]
...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets reset_btn]
...
#   set_false_path -from [get_ports {touch_btn[*]}]
#   set_false_path -from [get_ports {dip_sw[*]}]
#   set_false_path -to [get_ports {leds[*]}]
#   set_false_path -to [get_ports {dpy0[*]}]
#   set_false_path -to [get_ports {dpy1[*]}]
